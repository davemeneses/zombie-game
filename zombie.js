...
// and now one more function if the user wants to play again
// function playAgain() {
//     inquirer
//       .prompt([
//         {
...
//     // I'm going to call the playGame function if the above conditional statements don't fire off.
//     // The only problem we have now is that we have no way to exit the game.
//   }
